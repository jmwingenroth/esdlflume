...
to_save = strcat('control output/outputcontrol',filename_VPro{f});
    ...
    for c = 1:nCells % treat each depth cell independently
        ...
        for ii = 1:4
            for jj = 1:4
                ...
                %Laurel: what is vpvp_mean?. ANSWER: This is the matrix of Reynolds stresses and turbulence intensities. (vp = v-prime, where v-prime is the "pertubation velocity," i.e., the deviation from the mean velocity along the x, y, or z direction) Reynolds stresses are the product of perturbation velocities along different directions, whereas turbulence intensities are the product of perturbation velocities along the same direction.
            end
        end
    end
    else % point ADV
